...
pub const POSITIONS: [Position; 24] = [
    ...
    Position { position: [-1.0, 1.0, -1.0], color: [1.0, 0.0, 0.0] },
    Position { position: [1.0, 1.0, -1.0], color: [1.0, 0.0, 0.0] },
    Position { position: [1.0, -1.0, -1.0], color: [1.0, 0.0, 0.0] },
    Position { position: [-1.0, -1.0, -1.0], color: [1.0, 0.0, 0.0] },

    // Front face (indices 4-7) - Green
    Position { position: [-1.0, 1.0, 1.0], color: [0.0, 1.0, 0.0] },
    Position { position: [1.0, 1.0, 1.0], color: [0.0, 1.0, 0.0] },
    Position { position: [1.0, -1.0, 1.0], color: [0.0, 1.0, 0.0] },
    Position { position: [-1.0, -1.0, 1.0], color: [0.0, 1.0, 0.0] },

    // Left face (indices 8-11) - Blue
    Position { position: [-1.0, 1.0, -1.0], color: [0.0, 0.0, 1.0] },
    Position { position: [-1.0, -1.0, -1.0], color: [0.0, 0.0, 1.0] },
    Position { position: [-1.0, -1.0, 1.0], color: [0.0, 0.0, 1.0] },
    Position { position: [-1.0, 1.0, 1.0], color: [0.0, 0.0, 1.0] },

    // Right face (indices 12-15) - Yellow
    Position { position: [1.0, 1.0, -1.0], color: [1.0, 1.0, 0.0] },
    Position { position: [1.0, 1.0, 1.0], color: [1.0, 1.0, 0.0] },
    Position { position: [1.0, -1.0, 1.0], color: [1.0, 1.0, 0.0] },
    Position { position: [1.0, -1.0, -1.0], color: [1.0, 1.0, 0.0] },

    // Bottom face (indices 16-19) - Magenta
    Position { position: [-1.0, 1.0, -1.0], color: [1.0, 0.0, 1.0] },
    Position { position: [-1.0, 1.0, 1.0], color: [1.0, 0.0, 1.0] },
    Position { position: [1.0, 1.0, 1.0], color: [1.0, 0.0, 1.0] },
    Position { position: [1.0, 1.0, -1.0], color: [1.0, 0.0, 1.0] },

    // Top face (indices 20-23) - Cyan
    Position { position: [-1.0, -1.0, -1.0], color: [0.0, 1.0, 1.0] },
    Position { position: [1.0, -1.0, -1.0], color: [0.0, 1.0, 1.0] },
    Position { position: [1.0, -1.0, 1.0], color: [0.0, 1.0, 1.0] },
    Position { position: [-1.0, -1.0, 1.0], color: [0.0, 1.0, 1.0] },
];
